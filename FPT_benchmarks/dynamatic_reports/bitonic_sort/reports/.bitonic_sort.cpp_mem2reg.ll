...
for.cond:                                         ; preds = %for.inc29, %entry
  %k.0 = phi i32 [ 2, %entry ], [ %shl, %for.inc29 ]
  %cmp = icmp sle i32 %k.0, 64
...
for.cond1:                                        ; preds = %for.inc26, %for.body
  %j.0 = phi i32 [ %shr, %for.body ], [ %shr27, %for.inc26 ]
