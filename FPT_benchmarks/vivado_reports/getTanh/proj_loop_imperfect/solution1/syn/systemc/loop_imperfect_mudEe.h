...
// ==============================================================
#ifndef __loop_imperfect_mudEe__HH__
#define __loop_imperfect_mudEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(loop_imperfect_mudEe) {
    ...
    SC_CTOR(loop_imperfect_mudEe):  ACMP_mul_us_U ("ACMP_mul_us_U") {
