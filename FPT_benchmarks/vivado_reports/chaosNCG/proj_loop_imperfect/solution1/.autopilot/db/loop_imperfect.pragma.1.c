...
void loop_imperfect(dout_t A[1000*3], din_t W[1000*3]);
# 94 "loop_imperfect.c" 2

void loop_imperfect(dout_t buffer[1000*3], din_t M[1000*3]) {_ssdm_SpecArrayDimSize(buffer, 3000);_ssdm_SpecArrayDimSize(M, 3000);
 int bound = 2 * 1000;
 const int I = 2;
 const int X = 2, Y = 3;
