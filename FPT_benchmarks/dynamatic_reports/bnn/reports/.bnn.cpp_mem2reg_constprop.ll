...
for.inc12:                                        ; preds = %for.end
  %inc13 = add nsw i32 %i.03, 1
  %cmp = icmp slt i32 %inc13, 100
  br i1 %cmp, label %for.body, label %for.end14

for.end14:                                        ; preds = %for.inc12
  %i.0.lcssa = phi i32 [ %inc13, %for.inc12 ]
  br label %for.body17

for.body17:                                       ; preds = %for.end14, %for.inc33
  %k.01 = phi i32 [ 0, %for.end14 ], [ %inc34, %for.inc33 ]
  %sub = sub nsw i32 %i.0.lcssa, 1
  %mul18 = mul nsw i32 %sub, 100
  %add19 = add nsw i32 %mul18, %k.01
...
for.inc33:                                        ; preds = %if.end
  %inc34 = add nsw i32 %k.01, 1
  %cmp16 = icmp slt i32 %inc34, 100
...
for.body:                                         ; preds = %entry, %for.inc26
  %i.02 = phi i32 [ 0, %entry ], [ %inc27, %for.inc26 ]
  br label %for.body3
...
for.inc26:                                        ; preds = %for.end
  %inc27 = add nsw i32 %i.02, 1
  %cmp = icmp slt i32 %inc27, 1
  br i1 %cmp, label %for.body, label %for.end28

for.end28:                                        ; preds = %for.inc26
  %arrayidx31 = getelementptr inbounds [1 x [10000 x i32]], [1 x [10000 x i32]]* %w, i64 0, i64 0
  %arraydecay = getelementptr inbounds [10000 x i32], [10000 x i32]* %arrayidx31, i32 0, i32 0
  %arrayidx33 = getelementptr inbounds [1 x [10000 x i32]], [1 x [10000 x i32]]* %in, i64 0, i64 0
  %arraydecay34 = getelementptr inbounds [10000 x i32], [10000 x i32]* %arrayidx33, i32 0, i32 0
  %arrayidx36 = getelementptr inbounds [1 x [10000 x i32]], [1 x [10000 x i32]]* %mean, i64 0, i64 0
  %arraydecay37 = getelementptr inbounds [10000 x i32], [10000 x i32]* %arrayidx36, i32 0, i32 0
  %arrayidx39 = getelementptr inbounds [1 x [10000 x i32]], [1 x [10000 x i32]]* %addr_in, i64 0, i64 0
  %arraydecay40 = getelementptr inbounds [10000 x i32], [10000 x i32]* %arrayidx39, i32 0, i32 0
  %arrayidx42 = getelementptr inbounds [1 x [10000 x i32]], [1 x [10000 x i32]]* %addr_out, i64 0, i64 0
  %arraydecay43 = getelementptr inbounds [10000 x i32], [10000 x i32]* %arrayidx42, i32 0, i32 0
  %arrayidx45 = getelementptr inbounds [1 x [10000 x i32]], [1 x [10000 x i32]]* %data, i64 0, i64 0
