...
// ==============================================================
# 1 "/home/dynamatic/getTanhDouble/loop_imperfect.c"
# 1 "/home/dynamatic/getTanhDouble/loop_imperfect.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/dynamatic/getTanhDouble/loop_imperfect.c" 2
# 93 "/home/dynamatic/getTanhDouble/loop_imperfect.c"
...
# 94 "/home/dynamatic/getTanhDouble/loop_imperfect.c" 2

void loop_imperfect(dout_t A[1000], din_t addr[1000]) {
 dout_t result, beta;
 int i;
 for(i = 0; i < 1000; i++) {
  int address = addr[i];
  ...
  result = ((beta * beta + 19.0f) * beta * beta + 3.0f) * beta;
