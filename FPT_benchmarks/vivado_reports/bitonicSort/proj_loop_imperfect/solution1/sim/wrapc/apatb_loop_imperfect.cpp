...
int A[64])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *A_pc_buffer = new sc_bv<32>[64];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: A
				{
					...
					// {
						// celement: A(31, 0)
						// {
							sc_lv<32>* A_lv0_0_63_1 = new sc_lv<32>[64];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: A(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 63; i_0 += 1)
							{
								...
								{
									A_lv0_0_63_1[hls_map_index].range(31, 0) = sc_bv<32>(A_pc_buffer[hls_map_index].range(31, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(31, 0)
					{
						...
						// celement: A(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 63; i_0 += 1)
							{
								...
								// output_type_conversion : (A_lv0_0_63_1[hls_map_index]).to_uint64()
								if (&(A[0]) != NULL) // check the null address if the c port is array or others
								{
									A[i_0] = (A_lv0_0_63_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
...
// [call_c_dut] ---------->
		...
		sc_bv<32>* A_tvout_wrapc_buffer = new sc_bv<32>[64];
