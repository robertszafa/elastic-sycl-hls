...
# synth_design -top vecTrans -part xcu250-figd2104-2L-e -no_iobuf -mode out_of_context # 270 MHz (hist, lsq size 16)
# synth_design -top vecTrans -part xcku5p-sfvb784-3-e -no_iobuf -mode out_of_context
# synth_design -top vecTrans -part xcvu125-flva2104-1-i -no_iobuf -mode out_of_context
