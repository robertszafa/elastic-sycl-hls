...
// wrapc file define: "C"
#define AUTOTB_TVIN_C  "../tv/cdatafile/c.loop_imperfect.autotvin_C.dat"
...
int C[1000])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *B_pc_buffer = new sc_bv<32>[1000];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: B
				{
					...
					// {
						// celement: B(31, 0)
						// {
							sc_lv<32>* B_lv0_0_999_1 = new sc_lv<32>[1000];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: B(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 999; i_0 += 1)
							{
								...
								{
									B_lv0_0_999_1[hls_map_index].range(31, 0) = sc_bv<32>(B_pc_buffer[hls_map_index].range(31, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(31, 0)
					{
						...
						// celement: B(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 999; i_0 += 1)
							{
								...
								// output_type_conversion : (B_lv0_0_999_1[hls_map_index]).to_uint64()
								if (&(B[0]) != NULL) // check the null address if the c port is array or others
								{
									B[i_0] = (B_lv0_0_999_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
	...
	else
	{
		...
		sc_bv<32>* B_tvin_wrapc_buffer = new sc_bv<32>[1000];
		...
		tcl_file.set_num(1000, &tcl_file.B_depth);
		...
		sc_bv<32>* C_tvin_wrapc_buffer = new sc_bv<32>[1000];
		...
		tcl_file.set_num(1000, &tcl_file.C_depth);
...
// [call_c_dut] ---------->
		...
		sc_bv<32>* B_tvout_wrapc_buffer = new sc_bv<32>[1000];
