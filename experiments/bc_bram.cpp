...
void sssp_cpu(std::vector<int> &adjList, std::vector<int> &numNeighboursLookup,
...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    try {
      ...
      sssp_cpu(adjList, numNeighboursLookup, path_counts_cpu, depths_cpu,
             numVertices, 0);
