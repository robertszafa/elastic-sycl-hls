...
// ==============================================================
#ifndef __loop_imperfect_sdfYi__HH__
#define __loop_imperfect_sdfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(loop_imperfect_sdfYi) {
    ...
    SC_CTOR(loop_imperfect_sdfYi):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
