...
set hlsProjectName proj_loop_imperfect
...
set ip_vlnv xilinx.com:hls:loop_imperfect:0.1
set ip_repo_path {../ip}
set assign_slr ""
...
run_report report_timing -max_paths 10 -file $outputDir/${top_module}_timing_paths_synth.rpt
run_report report_design_analysis -file $outputDir/${top_module}_design_analysis_synth.rpt
run_report ::tclapp::xilinx::designutils::report_failfast -detailed_report synth -file $outputDir/${top_module}_failfast_synth.rpt
# launch run impl
...
run_report report_design_analysis -file $outputDir/${top_module}_design_analysis_routed.rpt
run_report ::tclapp::xilinx::designutils::report_failfast -detailed_report impl -file $outputDir/${top_module}_failfast_routed.rpt
