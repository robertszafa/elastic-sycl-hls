...
proc create_root_design { parentCell } {
  ...
  set addr_address0 [ create_bd_port -dir O -from 9 -to 0 -type data addr_address0 ]
  set addr_ce0 [ create_bd_port -dir O addr_ce0 ]
  set addr_q0 [ create_bd_port -dir I -from 31 -to 0 -type data addr_q0 ]
  ...
  connect_bd_net -net addr_q0_0_1 [get_bd_ports addr_q0] [get_bd_pins hls_inst/addr_q0]
  ...
  connect_bd_net -net hls_inst_addr_address0 [get_bd_ports addr_address0] [get_bd_pins hls_inst/addr_address0]
  connect_bd_net -net hls_inst_addr_ce0 [get_bd_ports addr_ce0] [get_bd_pins hls_inst/addr_ce0]
