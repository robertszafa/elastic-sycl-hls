# 1 "/home/dynamatic/bnn/loop_imperfect.c"
# 1 "/home/dynamatic/bnn/loop_imperfect.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/dynamatic/bnn/loop_imperfect.c" 2
# 93 "/home/dynamatic/bnn/loop_imperfect.c"
...
# 94 "/home/dynamatic/bnn/loop_imperfect.c" 2

void loop_imperfect(dout_t data[100*100], din_t addr_in[100*100], din_t addr_out[100*100], din_t a[100*100]) {
 int w[100*100];
     int in[100*100];
     int mean[100*100];
     int alpha = 2;
