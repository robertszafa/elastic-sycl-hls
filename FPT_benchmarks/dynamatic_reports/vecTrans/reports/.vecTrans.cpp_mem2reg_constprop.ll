; ModuleID = '.vecTrans.cpp_mem2reg.ll'
...
for.body:                                         ; preds = %entry, %for.inc
  ...
  %idxprom14 = sext i32 %i.01 to i64
...
for.end18:                                        ; preds = %for.inc16
  %arrayidx21 = getelementptr inbounds [1 x [1000 x i32]], [1 x [1000 x i32]]* %a, i64 0, i64 0
  %arraydecay = getelementptr inbounds [1000 x i32], [1000 x i32]* %arrayidx21, i32 0, i32 0
  %arrayidx23 = getelementptr inbounds [1 x [1000 x i32]], [1 x [1000 x i32]]* %b, i64 0, i64 0
