...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("hist_address0", 10, hls_out, 1, "ap_memory", "mem_address", 1),
	...
	Port_Property("hist_q0", 32, hls_in, 1, "ap_memory", "mem_dout", 1),
	Port_Property("C_address0", 10, hls_out, 2, "ap_memory", "mem_address", 1),
