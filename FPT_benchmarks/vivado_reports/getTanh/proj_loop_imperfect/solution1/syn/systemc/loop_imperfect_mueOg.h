...
// ==============================================================
#ifndef __loop_imperfect_mueOg__HH__
#define __loop_imperfect_mueOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(loop_imperfect_mueOg) {
    ...
    SC_CTOR(loop_imperfect_mueOg):  ACMP_mul_us_U ("ACMP_mul_us_U") {
