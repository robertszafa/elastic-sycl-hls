...
void loop_imperfect(dout_t A[1000*2], din_t W[1000*2]);
# 94 "loop_imperfect.c" 2

void loop_imperfect(dout_t vertices[1000*2], din_t edges[1000*2]) {_ssdm_SpecArrayDimSize(vertices, 2000);_ssdm_SpecArrayDimSize(edges, 2000);
 int i = 0;
     int out_scalar = 0;
