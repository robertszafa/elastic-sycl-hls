...
// ==============================================================
#ifndef __loop_imperfect_srbkb__HH__
#define __loop_imperfect_srbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(loop_imperfect_srbkb) {
    ...
    SC_CTOR(loop_imperfect_srbkb):  ACMP_srem_seq_U ("ACMP_srem_seq_U") {
