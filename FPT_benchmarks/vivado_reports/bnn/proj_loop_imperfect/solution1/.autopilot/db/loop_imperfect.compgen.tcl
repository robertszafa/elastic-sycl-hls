...
set ID 2
set hasByteEnable 0
set MemName loop_imperfect_mean
set CoreName ap_simcore_mem
set PortList { 1 3 }
set DataWd 32
set AddrRange 10000
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename addr_in \
    op interface \
    ports { addr_in_address0 { O 14 vector } addr_in_ce0 { O 1 bit } addr_in_q0 { I 32 vector } addr_in_address1 { O 14 vector } addr_in_ce1 { O 1 bit } addr_in_q1 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename addr_out \
    op interface \
    ports { addr_out_address0 { O 14 vector } addr_out_ce0 { O 1 bit } addr_out_q0 { I 32 vector } } \
} "
} else {
