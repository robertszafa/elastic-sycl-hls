...
for.body:                                         ; preds = %entry, %for.inc11
  %ptr.04 = phi i32 [ 0, %entry ], [ %ptr.1.lcssa, %for.inc11 ]
  %k.03 = phi i32 [ 1, %entry ], [ %inc12, %for.inc11 ]
  br label %for.body3

for.body3:                                        ; preds = %for.body, %for.inc
  %p.02 = phi i32 [ 0, %for.body ], [ %inc10, %for.inc ]
  %ptr.11 = phi i32 [ %ptr.04, %for.body ], [ %inc, %for.inc ]
...
for.inc:                                          ; preds = %for.body3
  %inc10 = add nsw i32 %p.02, 1
  %cmp2 = icmp slt i32 %inc10, 20
  br i1 %cmp2, label %for.body3, label %for.end

for.end:                                          ; preds = %for.inc
  %ptr.1.lcssa = phi i32 [ %inc, %for.inc ]
  br label %for.inc11

for.inc11:                                        ; preds = %for.end
  %inc12 = add nsw i32 %k.03, 1
  %cmp = icmp slt i32 %inc12, 20
  br i1 %cmp, label %for.body, label %for.end13

for.end13:                                        ; preds = %for.inc11
  %k.0.lcssa = phi i32 [ %inc12, %for.inc11 ]
  ret i32 %k.0.lcssa
}
...
for.body3:                                        ; preds = %for.body, %for.inc23
  %ptr.04 = phi i32 [ 0, %for.body ], [ %ptr.1.lcssa, %for.inc23 ]
  %y.03 = phi i32 [ 0, %for.body ], [ %inc24, %for.inc23 ]
  br label %for.body6

for.body6:                                        ; preds = %for.body3, %for.inc
  %x.02 = phi i32 [ 0, %for.body3 ], [ %inc22, %for.inc ]
  %ptr.11 = phi i32 [ %ptr.04, %for.body3 ], [ %inc, %for.inc ]
  %call7 = call i32 @rand() #3
  %rem = srem i32 %call7, 100
  %idxprom8 = sext i32 %i.05 to i64
  ...
  %idxprom13 = sext i32 %i.05 to i64
  ...
  %idxprom18 = sext i32 %i.05 to i64
...
for.inc:                                          ; preds = %for.body6
  %inc22 = add nsw i32 %x.02, 1
  %cmp5 = icmp slt i32 %inc22, 20
...
for.inc23:                                        ; preds = %for.end
  %inc24 = add nsw i32 %y.03, 1
  %cmp2 = icmp slt i32 %inc24, 20
