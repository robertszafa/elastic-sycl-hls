...
module bd_0
   (A_address0,
    ...
    ap_ctrl_start,
    ap_rst);
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.A_ADDRESS0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.A_ADDRESS0, LAYERED_METADATA undef" *) output [5:0]A_address0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.A_ADDRESS1 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.A_ADDRESS1, LAYERED_METADATA undef" *) output [5:0]A_address1;
  output A_ce0;
  output A_ce1;
  ...
  wire ap_rst_0_1;
  wire [5:0]hls_inst_A_address0;
  wire [5:0]hls_inst_A_address1;
  wire hls_inst_A_ce0;
  wire hls_inst_A_ce1;
  ...
  assign A_address0[5:0] = hls_inst_A_address0;
  assign A_address1[5:0] = hls_inst_A_address1;
