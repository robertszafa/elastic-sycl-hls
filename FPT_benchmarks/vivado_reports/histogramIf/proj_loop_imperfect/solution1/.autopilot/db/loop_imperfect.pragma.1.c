...
void loop_imperfect(din_t A[1000], dout_t hist[1000], din_t C[1000]);
# 94 "loop_imperfect.c" 2

void loop_imperfect(din_t A[1000], dout_t hist[1000], din_t C[1000]) {_ssdm_SpecArrayDimSize(A, 1000);_ssdm_SpecArrayDimSize(hist, 1000);_ssdm_SpecArrayDimSize(C, 1000);
 int s = 1;
