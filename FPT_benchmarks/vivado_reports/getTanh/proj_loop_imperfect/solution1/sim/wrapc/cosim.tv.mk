...
AUTOPILOT_ROOT := /home/dynamatic/opt/xilinx/Vivado/2019.2
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /home/dynamatic/opt/xilinx/Vivado/2019.2/tps/lnx64/gcc-6.2.0/bin
endif
...
$(ObjDir)/loop_imperfect_test.c_pre.c.tb.o : loop_imperfect_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) loop_imperfect_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/loop_imperfect.c_pre.c.tb.o : loop_imperfect.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) loop_imperfect.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
