...
for.body:                                         ; preds = %entry, %for.inc40
  %i.05 = phi i32 [ 0, %entry ], [ %inc41, %for.inc40 ]
...
for.body18:                                       ; preds = %if.end15, %for.inc
  %k.04 = phi i32 [ 1, %if.end15 ], [ %inc, %for.inc ]
  %beta.03 = phi i32 [ %sub, %if.end15 ], [ %add26, %for.inc ]
  %x.02 = phi i32 [ 4945, %if.end15 ], [ %sub23, %for.inc ]
  %y.01 = phi i32 [ 1, %if.end15 ], [ %sub25, %for.inc ]
...
for.end:                                          ; preds = %for.inc
  %y.0.lcssa = phi i32 [ %sub25, %for.inc ]
  %x.0.lcssa = phi i32 [ %sub23, %for.inc ]
...
for.end42:                                        ; preds = %for.inc40
  %result.0.lcssa = phi i32 [ %mul35, %for.inc40 ]
