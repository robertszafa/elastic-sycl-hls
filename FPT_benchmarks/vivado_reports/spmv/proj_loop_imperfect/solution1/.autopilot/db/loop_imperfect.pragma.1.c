...
void loop_imperfect(dout_t matrix[20*20], din_t row[20*20], din_t col[20*20], din_t a[20*20]);
# 94 "loop_imperfect.c" 2

void loop_imperfect(dout_t matrix[20*20], din_t row[20*20], din_t col[20*20], din_t a[20*20]) {_ssdm_SpecArrayDimSize(matrix, 400);_ssdm_SpecArrayDimSize(row, 400);_ssdm_SpecArrayDimSize(col, 400);_ssdm_SpecArrayDimSize(a, 400);
 int ptr = 0;
 for (int k = 1; k < 20; k++) {
