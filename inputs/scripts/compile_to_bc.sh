...
# -mem2reg --deadargelim-sycl --simplifycfg --loop-simplifycfg --loop-rotate --lcssa --instcombine --instsimplify --aggressive-instcombine --interleaved-access --dse --adce --sroa --gvn 
...
~/git/llvm/build/bin/llvm-cxxfilt < "$1".ll > "$1".demangled.l 
