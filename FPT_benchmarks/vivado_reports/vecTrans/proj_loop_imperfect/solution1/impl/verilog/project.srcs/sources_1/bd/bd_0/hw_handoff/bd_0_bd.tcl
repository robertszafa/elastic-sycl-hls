...
proc create_root_design { parentCell } {
  ...
  set b_address0 [ create_bd_port -dir O -from 9 -to 0 -type data b_address0 ]
  set b_ce0 [ create_bd_port -dir O b_ce0 ]
  set b_q0 [ create_bd_port -dir I -from 31 -to 0 -type data b_q0 ]
  ...
  connect_bd_net -net b_q0_0_1 [get_bd_ports b_q0] [get_bd_pins hls_inst/b_q0]
  ...
  connect_bd_net -net hls_inst_b_address0 [get_bd_ports b_address0] [get_bd_pins hls_inst/b_address0]
  connect_bd_net -net hls_inst_b_ce0 [get_bd_ports b_ce0] [get_bd_pins hls_inst/b_ce0]
